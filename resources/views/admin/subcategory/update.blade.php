        ...
        <div class="container-fluid my-3">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <a href="{{route('admin-subcategory')}}" class="float-end text-light"><i class="fa fa-backward float-end text-light"> Back</i></a></h5>
                    <form action="{{route('admin-update-subcategory',$data->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
