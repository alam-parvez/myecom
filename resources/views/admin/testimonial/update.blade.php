        ...
        <div class="container-fluid my-3">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <form action="{{route('admin-update-testimonials',$data->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="message"  rows="5" class="form-control border-3 border-secondary" placeholder="Message...">{{old('message')?old('message'):$data->message}}</textarea>
                            @error('messsage')
                            <p class="text-danger">{{$message}}</p>
