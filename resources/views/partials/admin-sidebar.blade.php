<div class="list-group">
  ...
  <a href="{{route('admin-testimonials')}}" class="list-group-item list-group-item-action bg-secondary text-light" aria-current="true"><i class="fa fa-star fs-4"></i><span class="float-end">Testimonials</span></a>
